...
const CardDelivery = ({title, img, deliveryDays, weight, price}: ICardDelivery) => {
    return (
        <div className="card-delivery">
            ...
            <div className="card-delivery__body">
                ...
                <div className="card-delivery__price"><span className="card-delivery__price card-delivery__price--grey">от</span> <span className="card-delivery__price card-delivery__price--lg">{price}</span>$/кг</div>
